...
<div id="cart">
	...
	<div id="opsinfo_title" class="titlebox" style="width:1010px; margin-left:100px">상품정보</div>
		<!-- 	<div id="orderlist">	
			...
			<div id="orderlist_fn">
				...
				<c:forEach var="cartlist" items="${cartlist}">
					<form class="cartlist_each" id="form_${cartlist.pno}" name="form_${cartlist.pno}" method="post">
						<div id="cart_listeach" style="margin-right:50px;">
							<div id="checkeach">
							...
							<div id="pd_info">
								...
								<div id="pd_delete"><a href="deletecart?pno=${cartlist.pno}"></a></div>
						</div>
					</form>	
				</c:forEach>
				...
				<form id="orderinfo" action="order" method="post">
					<div id="order-personalinfo" class="olist_infobox">
						<div id="opsinfo_title" class="titlebox">주문정보</div><br/>
				...
				<br/>
					<div id="order_other">
						<div id="order-deliinfo" class="olist_infobox">
							<div id="ordinfo_title" class="titlebox">배송정보</div><br/>
