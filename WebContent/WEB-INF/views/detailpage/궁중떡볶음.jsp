	...
	<div id = "detailpage">
		...
		<section id="sec01">
			<div id ="div01">
				...
				<img width="450px" height="530px" src="./img/detailpage/궁중떡볶음/궁중_1.jpg"/>
				</div>
			<div id ="div02">
		...
		<section id="sec02">
			...
			<ul id= "menu02">
				...
				<div id="div04">
					<img width="1100px" src="./img/detailpage/궁중떡볶음/궁중_2.jpg"/>
				</div>
			<div id="div05">
				<h8>간단하게 만드는 일품요리</h8>
				<br/>
			...
			<div id="div06">
				...
				<img width="1100px"  src="./img/detailpage/궁중떡볶음/궁중_3.jpg"/>
			</div>
			<div id="div07">
				<hr >
				<h11>밥향기's Point</h11>
			...
			<div id="div08">
				<hr>
				<h14>밥향기's Pick</h14>
				<img width="1100px" src="./img/detailpage/궁중떡볶음/궁중_4.jpg">
			</div>
			<div id="div09">
				<h15>수라상 궁중 떡볶음</h15>
				<ul>
			...
			<div id="div10">
				<h16>밥향기's Tip!</h16>
					<div id="div10_1">
					<img width="900px" src="./img/detailpage/궁중떡볶음/궁중_5.jpg"/>
					...
					<div id="div10_2">
					<img width="900px"  src="./img/detailpage/궁중떡볶음/궁중_6.jpg"/>
