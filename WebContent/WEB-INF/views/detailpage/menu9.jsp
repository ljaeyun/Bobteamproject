	...
	<body>
		...
		<section id="sec01">
			<div id ="div01">
				...
				<img width="450px" height="530px" src="<%=application.getContextPath()%>/resources/img/detailpage/두루치기/두루치기_1.jpg"/>
				</div>
			<div id ="div02">
				<h1>담백한 두부와 칼칼한 국물의 만남 <br/>대전식 두부두루치기</h1>
		...
		<section id="sec02">
			...
			<ul id= "menu02">
				...
				<div id="div04">
					<img width="1100px" src="<%=application.getContextPath()%>/resources/img/detailpage/두루치기/두루치기_2.jpg"/>
				</div>
			<div id="div05">
				<h8>손쉽게 완성하는 일품요리</h8>
				<br/>
				<h9>할머니 손맛 <br/>대전식 두부 두루치기</h9>
				
				<hr>
				<p>특별한 모임을 염두해 두고 있는 분이라면,밥향기 유기농 두부 갈릭버터 치즈 오븐구이를 주목해주세요.
				특출난 요리 실력이 없어도 근사한
				<br/>유기농 두부 요리를 완성할 수 있어요. 어획 후 자숙하여 급속 냉동한 제품으로 조리가 매우 간단하답니다
				. 가위로 쓱쓱 손질한 뒤 동봉된 갈릭버터
				<br/>소스와 모짜렐라 치즈를 뿌려 조리하면 고소한 풍미의 유기농 두부가 금세 완성되죠.캐나다산 제철 유기농 두부만을 선별하여 
				신선하고 쫄깃한 식감<br/>이 살아있답니다. 몸통은 물론 집게까지 살이 통통하게 오른 유기농 두부를 보내드리니,
				 식탁위 특별함을 더해보세요.</p>
			</div>
			<div id="div06">
				<h10>영상으로 미리 만나는 유기농 두부<br/>대전식 두부 두루치기</h10>
				<img width="1100px"  src="<%=application.getContextPath()%>/resources/img/detailpage/두루치기/두루치기_3.jpg"/>
			</div>
			<div id="div07">
				<hr >
				<h11>밥향기's Point</h11>
				...
				<div id="div07_1">
					...
					<ul>
						...
						<li>어획 후 한 번 익혀 급속 냉동한 유기농 두부</li>
					</ul>
					</div>
					</div>
			...
			<div id="div08">
				<hr>
				<h14>밥향기's Pick</h14>
				<img width="1100px" src="<%=application.getContextPath()%>/resources/img/detailpage/두루치기/두루치기_4.jpg">
			</div>
			<div id="div09">
				<h15>대전식 두부 두루치기</h15>
				<ul>
					<li><b>구성:</b>①유기농 두부(450g), ②모짜렐라 치즈(35g), ③갈릭버터치즈(35g)</li>
					<li><b>특징:</b>속이 꽉찬 캐나다산 유기농 두부를 자숙한 뒤 냉동해 손질과 조리가 편리한 제품이에요. 모짜렐라 치즈와 갈릭버터 소스가<br/>
			...
			<div id="div10">
				<h16>밥향기's Tip!</h16>
					<div id="div10_1">
					<img width="900px" src="<%=application.getContextPath()%>/resources/img/detailpage/두루치기/두루치기_5.jpg"/>
			
					<h17>손질법을 확인하세요</h17>
					<ul>
						<li>포장을 제외한 유기농 두부를 흐르는 물에 10분간 씻어주세요</li>
						<li>유기농 두부를 뒤집어 꼬리부터 머리까지 반으로 잘라주세요</li>
						<li>유기농 두부의 살부분에 갈릭버터 소스를 바르고 모짜렐라 치즈를 뿌려주세요.</li>
					</ul>
					<h17>에어프라이어로 간편하게 조리하세요</h17>
					<ul>
						<li>토핑된 유기농 두부를 에어프라이어에 넣고 180˚C에서 약 12분간 조리하세요 </li>
						<li>유기농 두부 한마리를 조리하기 위해서는 6L이상의 대용량 에어프라이어가 필요해요.</li>
					</ul>
					<h17>팬프라이어로 깊은 풍미를 살려 조리하세요</h17>
					<ul>
						<li>중불로 달군 펜에 버터나 오일을 둘러주세요 </li>
						<li>토핑된 유기농 두부를 프라이펜에 올려 뚜겅을 덮은 뒤 중불에서 7~8분정도 조리해주세요.</li>
					</ul>
					</div>
					
					<div id="div10_2">
					<img width="900px"  src="<%=application.getContextPath()%>/resources/img/detailpage/두루치기/두루치기_6.jpg"/>
					<h17>완성된 유기농 두부는 이렇게 드세요.</h17>
					<ul>
						<li>몸통부분은 포크와 나이프를 이용해 잘라드세요. 한 번 자숙한 제품이라 껍질과 살이 쉽게 분리됩니다.</li>
						<li>집게다리는 작은 다리를 역방향으로 눌러 껍질을  벗긴 뒤 살전체를 손으로 살살 꺼내 드세요.</li>
						<li>유기농 두부의 내장은 볶음밥 재료로 활용하세요. 감칠맛나는 별미를 즐길 수 있어요</li>
					</ul>
					</div>
			</div>
			<div id="div11">
			...
			<div id="div13">
				...
				<div id="div15">
					<a class="btn_page" id="pre"  href="to_previouspage9">이전 페이지</a>
					<a class="btn_page" id="tocategory" href="to_category9">카테고리</a>
					<a class="btn_page" id="next" href="to_nextpage9">다음 페이지</a>
				</div>
				</div>
