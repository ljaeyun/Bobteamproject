		...
		<section id="sec02">
			...
			<div id="div13">
				...
				<div id="div14">
					...
					<div id="div15">
					<a class="btn_page" id="pre"  href="to_previouspage8">이전 페이지</a>
					<a class="btn_page" id="tocategory" href="to_category8">카테고리</a>
					<a class="btn_page" id="next" href="to_nextpage8">다음 페이지</a>
				</div>
				</div>
