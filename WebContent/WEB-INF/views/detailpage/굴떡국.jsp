	...
	<body>
		...
		<section id="sec02">
			...
			<div id="div05">
				...
				<br/>
				<h9>든든한 새해 시작 <br/>매생이굴떡국</h9>
				
				<hr>
				<p>특별한 모임을 염두해 두고 있는 분이라면,밥향기 생굴 갈릭버터 치즈 오븐구이를 주목해주세요.
				특출난 요리 실력이 없어도 근사한
				<br/>생굴 요리를 완성할 수 있어요. 어획 후 자숙하여 급속 냉동한 제품으로 조리가 매우 간단하답니다
				. 가위로 쓱쓱 손질한 뒤 동봉된 갈릭버터
				<br/>소스와 모짜렐라 치즈를 뿌려 조리하면 고소한 풍미의 생굴가 금세 완성되죠.캐나다산 제철 생굴만을 선별하여 
				신선하고 쫄깃한 식감<br/>이 살아있답니다. 몸통은 물론 집게까지 살이 통통하게 오른 생굴를 보내드리니,
				 식탁위 특별함을 더해보세요.</p>
			</div>
			<div id="div06">
			...
			<div id="div09">
				<h15>매생이굴떡국</h15>
				<ul>
					<li><b>구성:</b>①생굴(450g), ②모짜렐라 치즈(35g), ③갈릭버터치즈(35g)</li>
					<li><b>특징:</b>속이 꽉찬 캐나다산 생굴를 자숙한 뒤 냉동해 손질과 조리가 편리한 제품이에요. 모짜렐라 치즈와 갈릭버터 소스가<br/>
			...
			<div id="div10">
				<h16>밥향기's Tip!</h16>
					...
					<h17>손질법을 확인하세요</h17>
					<ul>
						<li>포장을 제외한 생굴를 흐르는 물에 10분간 씻어주세요</li>
						<li>생굴를 뒤집어 꼬리부터 머리까지 반으로 잘라주세요</li>
						<li>생굴의 살부분에 갈릭버터 소스를 바르고 모짜렐라 치즈를 뿌려주세요.</li>
					</ul>
					<h17>에어프라이어로 간편하게 조리하세요</h17>
					<ul>
						<li>토핑된 생굴를 에어프라이어에 넣고 180˚C에서 약 12분간 조리하세요 </li>
						<li>생굴 한마리를 조리하기 위해서는 6L이상의 대용량 에어프라이어가 필요해요.</li>
					</ul>
					<h17>팬프라이어로 깊은 풍미를 살려 조리하세요</h17>
					<ul>
						<li>중불로 달군 펜에 버터나 오일을 둘러주세요 </li>
						<li>토핑된 생굴를 프라이펜에 올려 뚜겅을 덮은 뒤 중불에서 7~8분정도 조리해주세요.</li>
					</ul>
					</div>
					...
					<ul>
						...
						<li>생굴의 내장은 볶음밥 재료로 활용하세요. 감칠맛나는 별미를 즐길 수 있어요</li>
					</ul>
					</div>
			</div>
			<div id="div11">
